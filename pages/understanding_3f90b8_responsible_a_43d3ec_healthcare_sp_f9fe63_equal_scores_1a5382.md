...
show_ads: true
description: Patients with the same algorithmic score could have very different illness burdens, revealing hidden racial disparity in care allocation.
hero_summary: Patients with the same algorithmic score could have very different illness burdens, revealing hidden racial disparity in care allocation.
layout: default
...
- /responsible-ai/
- /health-proxy/
nav_short_title: Equal Scores
title: When equal risk scores hide unequal illness
title_full: When equal risk scores hide unequal illness
display_title_short: Equal Scores
display_title: Equal Scores
heading_title: When equal risk scores hide unequal illness
page_heading_title: When equal risk scores hide unequal illness
source_count: 9
infographic_count: 3
planned_sections:
...
image: /assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-3-dark.svg" | relative_url }}" alt="Equal Scores illustration 3" data-theme-src-dark="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

<img src="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-2-dark.svg" | relative_url }}" alt="Equal Scores illustration 2" data-theme-src-dark="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/understanding_3f90b8_responsible_a_43d3ec_healthcare_sp_f9fe63_equal_scores_1a5382-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why group-level checks matter before deployment
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides context on systemic bias and measurement choices.</p>
        <div class="fr-book-actions">
