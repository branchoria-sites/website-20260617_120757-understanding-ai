...
show_ads: true
description: Short factual tests can hide the way errors accumulate when an AI answer contains many linked claims.
hero_summary: Short factual tests can hide the way errors accumulate when an AI answer contains many linked claims.
layout: default
...
- /ai-errors/
- /benchmark-gaps/
nav_short_title: Long Answers
title: Why Long AI Answers Fail Differently
title_full: Why Long AI Answers Fail Differently
display_title_short: Long Answers
display_title: Long Answers
heading_title: Why Long AI Answers Fail Differently
page_heading_title: Why Long AI Answers Fail Differently
source_count: 11
infographic_count: 3
planned_sections:
...
image: /assets/images/understanding_3f90b8_ai_hallucinat_237932_ai_benchmark_818a45_long_answer_m_f82810-Illustration-1-social.jpg
---
...
One reason these failures are difficult to detect is that [language models]({{ 'language-models/' | relative_url }}) are designed to produce fluent text.
...
<img src="{{ "/assets/images/understanding_3f90b8_ai_hallucinat_237932_ai_benchmark_818a45_long_answer_m_f82810-Illustration-2-dark.svg" | relative_url }}" alt="Long Answers illustration 2" data-theme-src-dark="{{ "/assets/images/understanding_3f90b8_ai_hallucinat_237932_ai_benchmark_818a45_long_answer_m_f82810-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/understanding_3f90b8_ai_hallucinat_237932_ai_benchmark_818a45_long_answer_m_f82810-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding error accumulation and uncertainty.</p>
        <div class="fr-book-actions">
