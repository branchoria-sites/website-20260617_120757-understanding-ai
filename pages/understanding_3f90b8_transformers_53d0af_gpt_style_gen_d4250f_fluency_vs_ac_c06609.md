...
show_ads: true
description: The same next-token prediction process that enables flexible generation can also produce confident factual errors.
hero_summary: The same next-token prediction process that enables flexible generation can also produce confident factual errors.
layout: default
...
- /transformers/
- /gpt-generators/
nav_short_title: Fluency vs Accuracy
title: Why Convincing AI Responses Still Make Mistakes
title_full: Why Convincing AI Responses Still Make Mistakes
display_title_short: Fluency vs Accuracy
display_title: Fluency vs Accuracy
heading_title: Why Convincing AI Responses Still Make Mistakes
page_heading_title: Why Convincing AI Responses Still Make Mistakes
source_count: 67
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why GPT 3 Changed How People Used AI
header:
  og_image: /assets/images/understanding_3f90b8_transformers_53d0af_gpt_style_gen_d4250f_fluency_vs_ac_c06609-Illustration-1-social.jpg
  preview_image: /assets/images/understanding_3f90b8_transformers_53d0af_gpt_style_gen_d4250f_fluency_vs_ac_c06609-Illustration-1.webp
image: /assets/images/understanding_3f90b8_transformers_53d0af_gpt_style_gen_d4250f_fluency_vs_ac_c06609-Illustration-1-social.jpg
---

## Introduction

GPT-style [language models]({{ 'language-models/' | relative_url }}) can produce answers that sound knowledgeable, structured, and persuasive. That fluency is a direct consequence of how they are trained: they learn to predict likely continuations of text based on patterns found in enormous collections of human writing. The same mechanism that makes them flexible generators, however, also explains why they sometimes produce confident mistakes.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses uncertainty, reliability, and limitations of AI systems.</p>
        <div class="fr-book-actions">
