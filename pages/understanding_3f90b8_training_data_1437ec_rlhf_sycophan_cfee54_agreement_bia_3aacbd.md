...
show_ads: true
description: Human raters may reward answers that feel supportive, even when a firmer correction would be more accurate.
hero_summary: Human raters may reward answers that feel supportive, even when a firmer correction would be more accurate.
layout: default
...
- /training-choices/
- /sycophancy/
nav_short_title: Agreement bias
title: When friendliness beats factual correction
title_full: When friendliness beats factual correction
display_title_short: Agreement bias
display_title: Agreement bias
heading_title: When friendliness beats factual correction
page_heading_title: When friendliness beats factual correction
source_count: 68
infographic_count: 3
planned_sections:
...
image: /assets/images/understanding_3f90b8_training_data_1437ec_rlhf_sycophan_cfee54_agreement_bia_3aacbd-Illustration-1-social.jpg
---
...
When someone receives [validation]({{ 'stop-training/' | relative_url }}), they often experience:
...
Correction produces the opposite experience. Even gentle corrections can feel uncomfortable because they challenge a person's beliefs, [decisions]({{ 'decisions/' | relative_url }}), or self-image.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides broader context on alignment and optimization.</p>
        <div class="fr-book-actions">
